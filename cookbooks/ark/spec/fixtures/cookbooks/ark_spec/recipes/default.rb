...
ark 'foo_tbz' do
  url 'https://github.com/chef-cookbooks/ark/raw/master/files/default/foo.tbz'
  version '3'
end

ark 'foo_tgz' do
  url 'https://github.com/chef-cookbooks/ark/raw/master/files/default/foo.tgz'
  version '3'
end

ark 'foo_txz' do
  url 'https://github.com/chef-cookbooks/ark/raw/master/files/default/foo.txz'
  version '3'
...
ark 'foo_sub' do
  url 'https://github.com/chef-cookbooks/ark/raw/master/files/default/foo_sub.tar.gz'
  version '1'
  strip_components 2
end

ark 'foo_sub' do
  url 'https://github.com/chef-cookbooks/ark/raw/master/files/default/foo_sub.zip'
  version '2'
  strip_components 2
end
